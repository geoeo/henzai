...
let loadAssets = 
    ...
    //let rtModel = AssimpLoader.LoadFromFileWithRealtimeMaterial<VertexPositionNormal>(AppContext.BaseDirectory, "Models/duck.dae", VertexPosition.HenzaiType, AssimpLoader.RaytracePostProcessSteps)
