    ...
    sealed class SponzaScene : Renderable
    {
        ...
        override protected void CreateResources(){
            ...
            var modelRuntimeState 
                = new ModelRuntimeDescriptor<VertexPositionNormal>(model,"Phong","Phong", VertexRuntimeTypes.VertexPositionNormal,PrimitiveTopology.TriangleList,RenderFlags.NORMAL | RenderFlags.SHADOW_MAP, new InstancingRenderDescription(RenderFlags.NONE, InstancingDataFlags.EMPTY));
            ...
            var sponzaRuntimeStateColorOnly = new ModelRuntimeDescriptor<VertexPositionColor>(sponzaPC,"Color","Color", VertexRuntimeTypes.VertexPositionColor,PrimitiveTopology.TriangleList, RenderFlags.NORMAL | RenderFlags.SHADOW_MAP, new InstancingRenderDescription(RenderFlags.NONE, InstancingDataFlags.EMPTY));
            ...
            _skyBoxRuntimeState = new ModelRuntimeDescriptor<VertexPosition>(skyBox, "Skybox", "Skybox", VertexRuntimeTypes.VertexPosition, PrimitiveTopology.TriangleList, RenderFlags.NORMAL | RenderFlags.SHADOW_MAP, new InstancingRenderDescription(RenderFlags.NONE, InstancingDataFlags.EMPTY));
