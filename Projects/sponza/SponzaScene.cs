    ...
    sealed class SponzaScene : Renderable
    {
        ...
        override protected void CreateResources(){
            ...
            var modelRuntimeState 
                = new ModelRuntimeDescriptor<VertexPositionNormal>(model,"Phong","Phong", VertexRuntimeTypes.VertexPositionNormal,PrimitiveTopology.TriangleList, RenderFlags.SHADOW_MAP, RenderFlags.NONE, InstancingFlags.EMPTY);
            ...
            var planeRuntimeState = new ModelRuntimeDescriptor<VertexPositionNormal>(plane,"Phong","Phong", VertexRuntimeTypes.VertexPositionNormal,PrimitiveTopology.TriangleStrip,  RenderFlags.SHADOW_MAP, RenderFlags.NONE, InstancingFlags.EMPTY);
            ...
            var sponzaRuntimeState 
                = new ModelRuntimeDescriptor<VertexPositionNormalTextureTangentBitangent>(sponzaPNTTB,"PhongBitangentTexture","PhongBitangentTexture", VertexRuntimeTypes.VertexPositionNormalTextureTangentBitangent,PrimitiveTopology.TriangleList,  RenderFlags.SHADOW_MAP, RenderFlags.NONE, InstancingFlags.EMPTY);
            ...
            var sponzaRuntimeStateColorOnly = new ModelRuntimeDescriptor<VertexPositionColor>(sponzaPC,"Color","Color", VertexRuntimeTypes.VertexPositionColor,PrimitiveTopology.TriangleList,  RenderFlags.SHADOW_MAP, RenderFlags.NONE, InstancingFlags.EMPTY);
            ...
            _skyBoxRuntimeState = new ModelRuntimeDescriptor<VertexPosition>(skyBox, "Skybox", "Skybox", VertexRuntimeTypes.VertexPosition, PrimitiveTopology.TriangleList,  RenderFlags.SHADOW_MAP, RenderFlags.NONE, InstancingFlags.EMPTY);
            ...
            var sunRuntimeState = new ModelRuntimeDescriptor<VertexPositionNormal>(_sun, "Phong", "PhongNoShadow", VertexRuntimeTypes.VertexPositionNormal, PrimitiveTopology.TriangleList, RenderFlags.NONE, RenderFlags.NONE, InstancingFlags.EMPTY);
