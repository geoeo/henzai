...
namespace Henzai.Examples
{
    sealed class LightsScene : Renderable
    {
        ...
        override protected void CreateResources(){
            ...
            var lightCam = new OrthographicCamera(RenderResoultion.Horizontal,RenderResoultion.Vertical,Light.DEFAULT_POSITION, Light.DEFAULT_LOOKAT, Light.DEFAULT_UP);
            var spotLightCam = new OrthographicCamera(RenderResoultion.Horizontal,RenderResoultion.Vertical,new Vector4(0.0f,5.0f,7.0f,1.0f), Light.DEFAULT_LOOKAT, Light.DEFAULT_UP);
            ...
            var spotLightRuntimeState = new ModelRuntimeDescriptor<VertexPositionNormal>(spotlight,"Phong","Phong", VertexRuntimeTypes.VertexPositionNormal,PrimitiveTopology.TriangleList, RenderFlags.NORMAL | RenderFlags.SHADOW_MAP);
